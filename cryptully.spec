...
exe = EXE(pyz,
          ...
          a.zipfiles,
          a.datas + [('images/client.png', 'cryptully/images/client.png', 'DATA'),
                     ('images/server.png', 'cryptully/images/server.png', 'DATA'),
                     ('images/light/delete.png', 'cryptully/images/light/delete.png', 'DATA'),
